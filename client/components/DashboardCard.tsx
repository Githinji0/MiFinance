export default function DashboardCard({icon, title, value}: {icon: React.ReactNode, title: string, value: string}) {
    return(
        <div className="flex border  rounded-lg p-4 items-center justify-center bg-zinc-50 font-sans dark:bg-black w-full gap-4 flex-col shadow-md shadow-gray-300 dark:shadow-text-muted">
